...
class MessagingPageGroup extends StatefulWidget {
  ...
  @override
  State<MessagingPageGroup> createState() => _MessagingPageGroupState();
}

class _MessagingPageGroupState extends State<MessagingPageGroup> {
