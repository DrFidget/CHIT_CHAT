...
//                   borderSide:
//                       BorderSide(color: Color.fromRGBO(109, 40, 217, 1.0)),
//                 ),
...
//       side: BorderSide(color: Colors.black), // Add side color for border
//     ),
...
class _AllUsersState extends State<AllUsers> {
  ...
  Widget build(BuildContext context) {
    return Container(
      color: const Color.fromRGBO(109, 40, 217, 1.0), // RGB color here
      child: Column(
        children: [
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                filled: true,
                fillColor:
                    const Color.fromRGBO(255, 207, 87, 1.0), // RGB color here
                enabledBorder: OutlineInputBorder(
